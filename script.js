...
/* =========================================================
   ...
   Forces website to reload API data correctly.
   Removes stale empty matches after code updates.
...
async function loadCompetition(){
  ...
  try{
    ...
    if(
      ...
      typeof hydrateFixturesFromSheet === 'function'
...
function renderAll(){
  ...
  if(
    ...
    typeof renderCompetitionHeader === 'function'
  ...
  if(
    ...
    typeof renderStandings === 'function'
...
// Force fresh data on every page open
...
window.addEventListener(
  ...
  ()=>{
    ...
    if(
      ...
      typeof loadCompetition === 'function'
